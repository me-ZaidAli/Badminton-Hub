...
const EXERCISES: ExerciseData[] = [
  ...
  { name: "Plank Hold", description: "Hold a straight-arm or forearm plank position. Keep body in straight line from head to heels. Builds core stability essential for badminton.", category: "CORE", difficulty: "EASY", durationMinutes: 1, sets: 3, location: "home" },
  ...
  { name: "Resistance Band Pulls", description: "Attach band to fixed point and practice pulling movements mimicking badminton strokes. Builds shot-specific muscle groups.", category: "GYM", difficulty: "EASY", reps: 15, sets: 3, location: "gym", equipment: "Resistance band" },
  { name: "Cable Rotations", description: "Use cable machine for rotational pulls simulating badminton swing. Builds core rotation strength.", category: "GYM", difficulty: "MEDIUM", reps: 12, sets: 3, location: "gym", equipment: "Cable machine" },
  ...
  { name: "Sprint Intervals", description: "30 second all-out sprint followed by 30 second rest. Mimics the stop-start nature of badminton rallies.", category: "CARDIO", difficulty: "HARD", durationMinutes: 10, location: "home" },
...
const EXERCISE_VIDEOS: VideoData[] = [
  ...
  { title: "Badminton Footwork Basics", youtubeUrl: "https://www.youtube.com/watch?v=HbVPHqcOv2M", category: "FOOTWORK", description: "Master the 6-corner footwork pattern that forms the foundation of all court movement." },
  { title: "Core Stability for Badminton", youtubeUrl: "https://www.youtube.com/watch?v=coHoKoeS3MM", category: "CORE", description: "Babolat coaches explain why core workout is crucial for badminton performance." },
  { title: "Home Exercises for Badminton", youtubeUrl: "https://www.youtube.com/watch?v=dZgVxmf6jkA", category: "HOME", description: "7 effective exercises you can do at home to improve your badminton game." },
  { title: "Jump Rope for Badminton Fitness", youtubeUrl: "https://www.youtube.com/watch?v=u3zgHI8QnqE", category: "CARDIO", description: "Skipping rope techniques to improve footwork speed and cardiovascular endurance." },
  { title: "Badminton Agility Training", youtubeUrl: "https://www.youtube.com/watch?v=4EvLfk15QJk", category: "FOOTWORK", description: "Agility ladder drills specifically designed for badminton players." },
  { title: "Badminton Shadow Practice Guide", youtubeUrl: "https://www.youtube.com/watch?v=QdSLVfFdKhI", category: "FOOTWORK", description: "How to practice shadow footwork effectively to improve court coverage." },
  { title: "Strength Training for Badminton", youtubeUrl: "https://www.youtube.com/watch?v=kzG5bLHZIJg", category: "STRENGTH", description: "Gym exercises specifically tailored for badminton players to build power." },
  { title: "Badminton Warm-Up Routine", youtubeUrl: "https://www.youtube.com/watch?v=iFBkCO1RTJQ", category: "FLEXIBILITY", description: "Complete dynamic warm-up routine before badminton training or matches." },
  ...
  { title: "Badminton Flexibility Routine", youtubeUrl: "https://www.youtube.com/watch?v=3vxHGBEqNAs", category: "FLEXIBILITY", description: "Essential stretches for badminton players to improve range of motion and prevent injury." },
  { title: "Solo Badminton Drills at Home", youtubeUrl: "https://www.youtube.com/watch?v=B1ie0loQKvQ", category: "HOME", description: "10 solo training drills you can do in any small space without a partner." },
];
