...
export const RULE_REGISTRY: RuleSeed[] = [
  ...
  // BSL Challenges
  { key: "bslChallengeReceived", category: "BSL", title: "Challenge incoming — {challengerClub}",
    message: "{challengerClub} just called you out for {numMatches} match{matchPlural} on {date}. Accept or decline.",
    placeholders: ["{challengerClub}", "{opponentClub}", "{numMatches}", "{matchPlural}", "{date}"] },
  { key: "bslChallengeAccepted", category: "BSL", title: "Challenge accepted — {opponentClub}",
    message: "{opponentClub} accepted your challenge on {date}. Game on!",
    placeholders: ["{challengerClub}", "{opponentClub}", "{date}"] },
  { key: "bslChallengeDeclined", category: "BSL", title: "Challenge declined — {opponentClub}",
    message: "{opponentClub} declined your challenge on {date}.",
    placeholders: ["{challengerClub}", "{opponentClub}", "{date}"] },
