...
const TILE_CATALOG: TileDef[] = [
  ...
  { id: "club-control-center",href: "/admin/control-center",         label: "Club Control Center",description: "Unified hub for clubs, plans, billing & features", icon: Building2,    color: "text-emerald-500", bg: "bg-emerald-500/10", category: "people-clubs",          testId: "tile-club-control-center" },
