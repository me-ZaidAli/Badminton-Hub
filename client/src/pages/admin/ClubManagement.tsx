...
const STANDARD_TEAM_ROLES = ["COORDINATOR", "ORGANISER", "COACH", "SUPPORT_COACH"] as const;
const TEAM_ROLE_META: Record<string, { label: string; chip: string }> = {
  ...
  SUPPORT_COACH: { label: "Support Coach", chip: "bg-emerald-500/15 text-emerald-700 dark:text-emerald-300 border-emerald-500/30" },
};
