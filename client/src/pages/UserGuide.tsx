...
const playerSections: GuideSection[] = [
  ...
  },
  {
    ...
    description: "Understand your appreciation tokens from club coordinators",
    steps: [
      "Recognition Cards appear in your Premium Wallet section on the Dashboard.",
      "Cards are discretionary appreciation tokens awarded by club coordinators to recognise positive contribution, support, and sportsmanship.",
      "Tap any card to flip it and see the back with details about why it was awarded.",
      "Tap the (i) info button on the wallet header for full legal information about what cards represent.",
      "Each card shows a 'Non-transferable' badge — cards are personal to you and cannot be transferred.",
      "If a card has an associated discretionary benefit, it will be applied by your club coordinator — there are no automatic payouts.",
      "Cards may have expiration dates — check the countdown timer shown beneath each card.",
    ],
    tips: [
      "Recognition Cards do not represent wages, salary, or guaranteed rewards.",
      "Any associated benefits are optional, irregular, and may be withdrawn at any time.",
      "Cards come in different rarity tiers: Standard, Rare, Epic, Legendary, and Mythic.",
      "View all your cards in the full-screen carousel by tapping 'View All'.",
    ],
  },
  {
    icon: Baby,
...
const adminSections: GuideSection[] = [
  ...
  },
  {
    ...
    description: "Create and run tournaments with brackets, groups, and prizes",
    steps: [
      "Go to 'Tournaments' in the sidebar to view and manage all tournaments.",
      "Click 'Create Tournament' to set up a new tournament with type (Club, Open, League, Friendly), dates, location, and entry fees.",
      "Configure categories (e.g. Men's Singles, Mixed Doubles) with skill level ranges and max players.",
      "Set separate entry fees for club members (internal) and external players.",
      "Manage registrations: approve, reject, or waitlist players from the Admin panel.",
      "For doubles tournaments, manage pair requests where players can request specific partners.",
      "Use the Bracket view to see and manage knockout rounds, or the Group view for round-robin stages.",
      "Submit match scores from the Matches tab — winners auto-advance in knockout brackets.",
      "Add prizes with titles, descriptions, placement, value, and icons for each category.",
      "Use the Finance tab to track entry fee payments, send payment reminders, and confirm payments.",
      "Lock a tournament to prevent further registration changes.",
    ],
    tips: [
      "Use 'Seed Demo Players' to populate a tournament with test data for development.",
      "Weekly payment reminders are automatically sent every Monday for unpaid tournament registrations.",
      "OPEN tournaments are visible to all users; other types are restricted to the owning club.",
      "Players receive in-app notifications when their registration is approved or when payment is confirmed.",
    ],
  },
  {
    icon: Monitor,
    title: "Court Management & Live Court View",
    description: "Manage courts and view all matches in real-time",
    steps: [
      "During a live session, the Courts tab shows all courts simultaneously in a responsive grid.",
      "Each court card displays the current match with player names, scores, and match status.",
      "The Live Court View refreshes automatically every 10 seconds — no manual refresh needed.",
      "Admins can assign matches to specific courts and update scores in real-time.",
      "Court names and hall names are configurable per session.",
    ],
    tips: [
      "The live view works well on large screens or projectors for displaying during sessions.",
      "Courts without active matches show as available.",
    ],
  },
  {
    icon: Target,
    title: "Player Skills Analytics",
    description: "Track and assess player skills with detailed analytics",
    steps: [
      "Go to the Coach section and select 'Player Skills' to access the skills analytics dashboard.",
      "Enrol players into the skills tracking programme from the enrolment management area.",
      "For each enrolled player, edit their skill profile with slider ratings, star ratings, and coach comments.",
      "Toggle priority skills to highlight areas a player should focus on.",
      "View radar and bar charts showing skill distribution and progress over time.",
      "Use bulk skill progress recording to update multiple players at once.",
      "All skill changes are tracked in an audit history for accountability.",
    ],
    tips: [
      "Skills tracking is available for League and Premium players.",
      "The weak/strong skill identification helps coaches plan targeted training sessions.",
      "Per-player skill editing is available at the dedicated player skills page.",
    ],
  },
  {
    icon: Award,
    title: "Recognition Cards (Admin)",
    description: "Issue and manage discretionary appreciation tokens for players",
    steps: [
      "Go to 'Recognition Cards' in the admin section to access the card management panel.",
      "Browse the Card Gallery to see all available card designs across rarity tiers (Standard to Mythic).",
      "Click 'Issue Card' to award a card to a player — select the player, card design, rarity, and optionally set a discretionary benefit value.",
      "Add a personal note explaining why the card was awarded.",
      "View Active Cards and Expired Cards tabs to see all issued cards grouped by player.",
      "Use the Appreciation Benefits tab to issue discretionary benefits for eligible active cards.",
      "Each card can only receive one benefit per week — the system prevents duplicates.",
      "Revoke cards if needed from the Active Cards view.",
      "View the Benefit History table to see all past benefit transactions.",
    ],
    tips: [
      "Recognition Cards are discretionary appreciation tokens — they do not represent wages or guaranteed rewards.",
      "Any associated benefits are optional, irregular, and may be withdrawn at any time.",
      "All benefit issuance requires manual admin approval — there are no automated payouts.",
      "Cards are non-transferable and personal to the recipient.",
    ],
  },
];
