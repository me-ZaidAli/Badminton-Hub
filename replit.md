...
-   **Privacy-Enhanced Public Views**: Public session and ranking views strip gender data from API responses. Users can set an optional nickname during registration that displays instead of their full name on public leaderboards. Unregistered players' names are blurred on public rankings. A privacy notice in the registration form explains public name visibility.
